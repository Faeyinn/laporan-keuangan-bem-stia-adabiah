                    ...
                    <div className="p-8 md:p-12">
                        <div className="prose prose-slate max-w-none">
                            <p className="lead text-xl text-slate-600">
                                Di BEM STIA Adabiah, kami mengutamakan privasi
                                dan keamanan data Anda. Kebijakan ini
                                menjelaskan bagaimana kami mengelola informasi
                                dalam Sistem Keuangan BEM.
                            </p>
                            ...
                            <div id="section-1" className="mb-10 scroll-mt-28">
                                ...
                                <p>
                                    Kami mengumpulkan informasi yang diperlukan
                                    untuk pengelolaan administrasi dan keuangan
                                    organisasi, termasuk:
                                </p>
                                <ul className="list-disc pl-6 marker:text-green-500">
                                    <li>
                                        Data identitas (Nama, NIM, Jabatan).
                                    </li>
                                    <li>
                                        Informasi kontak (Email, Nomor Telepon).
                                    </li>
                                    <li>
                                        Riwayat transaksi dan aktivitas dalam
                                        sistem.
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div id="section-2" className="mb-10 scroll-mt-28">
                                ...
                                <ul className="list-disc pl-6 marker:text-blue-500">
                                    <li>
                                        Memverifikasi identitas pengurus dan
                                        anggota.
                                    </li>
                                    <li>
                            ...
                            <div id="section-3" className="mb-10 scroll-mt-28">
                                ...
                                <p>
                                    ...
                                    teknis untuk melindungi data Anda dari akses
                                    yang tidak sah, termasuk enkripsi data
                                    sensitif dan pembatasan akses berbasis peran
                            ...
                            <div id="section-4" className="mb-10 scroll-mt-28">
                                ...
                                <p>
                                    Kami tidak menjual, memperdagangkan, atau
                                    menyewakan informasi pribadi pengguna kepada
                                    pihak ketiga. Data hanya dapat diakses oleh
                                    pihak yang berwenang dalam struktur
                                    organisasi BEM STIA Adabiah atau pihak
                                    kampus jika diperlukan untuk audit.
                                </p>
                            </div>
                            ...
                            <div id="section-5" className="mb-6 scroll-mt-28">
                                ...
                                <p>
                                    ...
                                    organisasi. Pengguna akan diberitahu jika
